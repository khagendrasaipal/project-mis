...
export class ProjectStageComponent {
  ...
  formLayout: any;
  baseurl="";
  constructor(public appConfig:AppConfig,private toastr: ToastrService, private fb: FormBuilder, private RS: ProjectStageService){
    this.formLayout = {
      id :[''],
      cycleid:['',Validators.required],
      stagename:['',Validators.required],
      stageorder: ['',Validators.required],   
...
cycles:any
  getCycle(){
    this.RS.getCycle().subscribe({next:(dt)=>{
      this.cycles = dt;
